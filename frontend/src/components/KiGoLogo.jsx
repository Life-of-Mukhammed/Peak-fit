...
// KiGo logo — gradient rounded square with a stylized K mark.
// Variants: 'light' (white text on dark bg) | 'dark' (slate text on light bg) | 'mark' (icon only)
export default function KiGoLogo({ size = 40, variant = 'light', subtitle, className = '', wordmarkClass = '' }) {
  const Mark = (
    <div
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="min-w-0">
        <div className={`font-extrabold leading-tight tracking-tight ${textColor} ${wordmarkClass || 'text-[15px]'}`}>KiGo</div>
