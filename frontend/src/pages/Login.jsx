    ...
    <div className="min-h-screen bg-sidebar relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative">
        <div className="flex flex-col items-center mb-8">
          <KiGoLogo variant="mark" size={64} className="mb-4" />
          <h1 className="text-3xl font-extrabold text-white tracking-tight">KiGo</h1>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-5 pt-5 border-t border-white/5 space-y-1.5">
            ...
            <div className="text-slate-600 text-[11px] text-center">Platform admin: <span className="text-emerald-400/70">kigo / kigo123</span></div>
          </div>
        </div>

        <p className="text-center text-slate-500 text-xs mt-6">
          © {new Date().getFullYear()} KiGo. Barcha huquqlar himoyalangan.
        </p>
      </div>
    </div>
  );
